...
saved_model = joblib.load('misa-v4-nodann-tuned-full.joblib')
...
#gpu if meron , if wala naman cpu yung gagamitin , should b ok for everyone
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

#pwinepwersa yung wavlm sa gpu
